	...
	*/
	...
	module.directive( "snackbar", ["$rootScope", "$compile", "$timeout", function($rootScope, $compile, $timeout) {
		...
		return function ( scope, element, attrs ) {
			...
			var snackbarColor = attrs.snackBarColor || "black-bg";
			...
			$rootScope.$on('createSnackbar', function(event, received) {
				...
				//snackbar template
				var template = "<div class=\"snackbar "+received.color +" snackbar-opened\"><span class=\"snackbar-content\">" + received.content + "</span></div>";
				//template compile
